...
//			System.out.println(this.pc);  //current instruction - no, play function
...
//		System.out.println(String.format("%06X", mapAddr( addr )));
//		System.out.println( mapAddr( addr ));
		System.out.println( addr );
		
		this.debug_mem[mapAddr( addr )] = "RR"; //(byte) 238;
